...
<!--
	...
	function _pageSizeSelectInit(){
		$('#_pageSizeSelect').val('${baseQuery.pager.pageSize}');
		//console.log($('#_pageSizeSelect'));
	}
	window.onload=_pageSizeSelectInit;
	...
	/* 	console.log($("#" + form));
		...
		// $("#content").load('list', $("#" + form).serialize(), function() {
           // $("#content").fadeIn("slow");
       // }
      //  );
		return false;
